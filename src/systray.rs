...
use tray_icon::menu::{AboutMetadata, Menu, MenuId, MenuItem, PredefinedMenuItem};
...
pub(crate) fn launch_taskbar_icon() -> (Arc<Mutex<Option<MenuId>>>, Arc<Mutex<Option<MenuId>>>) {
    ...
    std::thread::spawn(move || {
        ...
        let config_item: MenuItem = MenuItem::new("WebUI", true, None);
        let quit_item: MenuItem = MenuItem::new("Exit", true, None);
